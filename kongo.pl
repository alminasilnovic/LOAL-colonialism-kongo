...
describe(zelle) :- write('Du bist in einer dunklen Zelle. Es riecht nach Schimmel. Vielleicht ist hier irgendwo ein Schluessel.'), nl.
describe(gang) :- write('Ein enger Gang mit feuchten Wänden. Richtung Norden hörst du Schritte.'), nl.
describe(hof) :- write('Der Hof ist weit, aber eine Wache steht in der Nähe. Hier liegt etwas...'), nl.
describe(dschungel) :- write('Du hast den Dschungel erreicht. Freiheit?'), nl.
...
can_go(gang, n, hof) :-
        write('Die Tür zum Hof ist verschlossen. Du brauchst einen Schluessel.'), nl, fail.
...
can_go(hof, e, dschungel) :-
        write('Du kannst nicht fliehen ohne Beweise. Das Tagebuch fehlt dir.'), nl, fail.
...
instructions :-
        ...
        write('n. s. e. w.        -- Gehe Richtung Norden, Süden, etc.'), nl,
